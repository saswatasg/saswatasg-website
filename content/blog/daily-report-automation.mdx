...
3. **GA4 quota exhaustion** — the [GA4 Data API](https://developers.google.com/analytics/devguides/reporting/data/v1/quotas) has daily token quotas; we cache the service account token for 1hr
...
The "free" tier covers us completely — [Apps Script quotas](https://developers.google.com/apps-script/guides/services/quotas) allow far more runtime than a 15-minute daily job needs. The real cost is the *design time* — agreeing on the 88 rows took 3 meetings, 2 hours each.
