...
- **[Microsoft Clarity](https://clarity.microsoft.com/) heatmaps + scroll depth** on every category template.
...
That's the whole principle, compressed: **a category page is not a shelf. It's a first conversation.** ([Baymard's e-commerce UX research](https://baymard.com/research) makes the same case with 130,000+ hours of testing behind it.)
