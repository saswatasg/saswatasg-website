---
title: "I built my own LinkedIn outreach tool (766 commits later)"
description: "TGB Hunt: a self-hosted, open-source agent that finds recruiters, drafts intros, and never sends without my approval. 766 commits, GPLv3."
slug: "tgb-hunt-linkedin-outreach-agent"
date: 2026-07-14
updated: 2026-08-03
pillar: agents
persona: local-ai-builder
targetKeyword: "open source linkedin automation"
secondaryKeywords:
  - "linkedin automation tools"
  - "self-hosted linkedin agent"
  - "AI linkedin outreach"
anchorProject: tgb-hunt
faq:
  - q: "What is TGB Hunt?"
    a: "A self-hosted, open-source agent (GPLv3) that finds recruiters for a role I describe, then drafts personalized intros I approve before anything sends."
  - q: "Why build a LinkedIn outreach tool instead of using an existing SaaS?"
    a: "SaaS tools optimize for volume, not research. TGB Hunt does 20 minutes of research per prospect in seconds, then still needs my approval to send."
  - q: "Is automated LinkedIn outreach safe to run?"
    a: "Keep volume modest and the human in the loop — personalization beats scale. TGB Hunt drafts; I approve every send."
---
...
<Figure src="/blog-assets/tgb-hunt/architecture.svg" alt="TGB Hunt architecture: discovery → enrichment → draft intro → human gate → send" caption="Four stages, one gate. The human approves every send." />
