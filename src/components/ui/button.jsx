...
const buttonVariants = cva(
  'inline-flex items-center justify-center text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-ink text-white rounded-pill px-5 py-2.5 min-h-[44px] font-medium inline-flex items-center gap-2 hover:bg-lemon hover:text-ink',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline: 'bg-white border-2 border-ink text-ink rounded-pill px-5 py-2.5 min-h-[44px] font-medium uppercase tracking-wide hover:bg-ink hover:text-white',
        secondary: 'bg-lemon text-ink rounded-pill px-5 py-2.5 min-h-[44px] font-medium hover:bg-lemon/80',
